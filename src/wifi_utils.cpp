 ...
 */
bool WifiUtils::getIPAddress(uint8_t *ip) {
 ...
 */
bool WifiUtils::getIPAddressStr(char *ips) {
 ...
 * @param ip - output uint8_t[4]
 */
bool WifiUtils::getGWAddress(uint8_t *ip) {
 ...
 * @return - true if IP addres assigned
 */
bool WifiUtils::getGWAddressStr(char *ips) {
 ...
 * @param ip - output uint8_t[4]
 */
bool WifiUtils::getNetMask(uint8_t *ip) {
 ...
 * @return - true if IP addres assigned
 */
bool WifiUtils::getNetMaskStr(char *ips) {
 ...
 * @return true if successful
 */
bool WifiUtils::getMACAddressStr(char *macStr) {
	uint8_t mac[6];
 ...
 * @param sec
 */
void WifiUtils::setTimeSec(uint32_t sec){
	datetime_t date;
	struct tm * timeinfo;
